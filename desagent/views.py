...
def chatbot(request):
    if request.method == 'POST':
        ...
        # Define regex patterns for different types of messages
        patterns = {
            r'hello|hi|hey': 'Hello! Nice to meet you again!!',
            r'how are you\?': 'I am fine, thank you for asking!',
            r'what is your name\?': 'My name is DES Agent.',
            r'what is DES Soln\?': 'DES Soln is a software platform designed to facilitate waste management processes, providing insights and solutions for both India Waste Management (IWM) and Singapore Waste Management (SWM).',
            r'what is IWM\?': 'IWM stands for India Waste Management, which refers to the process of managing and handling waste generated within India. DES Soln offers tools and resources to optimize waste management practices in the Indian context.',
            r'what is SWM\?': 'SWM stands for Singapore Waste Management, which involves the management and disposal of waste in Singapore. DES Soln provides insights and strategies for efficient waste management in Singapore.',
            r'tell me about the website\?': 'DES Soln is a comprehensive platform that offers detailed information and resources related to waste management processes. It covers topics such as waste generation, collection, recycling, and disposal, providing valuable insights for businesses and individuals looking to improve their waste management practices.',
            r'what are the key features of DES Soln\?': 'DES Soln offers a range of features, including data analytics tools, educational resources, interactive forums, and real-time monitoring capabilities. Users can access information on waste generation trends, recycling rates, regulatory requirements, and best practices for sustainable waste management.',
            r'how can DES Soln benefit businesses\?': 'Businesses can leverage DES Soln to gain insights into their waste management processes, identify areas for improvement, and implement strategies to reduce waste generation, enhance recycling efforts, and minimize environmental impact. By adopting sustainable waste management practices, businesses can optimize resource utilization, reduce operational costs, and enhance their corporate social responsibility (CSR) initiatives.',
            r'how can individuals contribute to waste management efforts through DES Soln\?': 'Individuals can use DES Soln to learn about waste management practices, access tips for reducing waste at home and in their communities, and participate in recycling programs and initiatives. By adopting eco-friendly habits and promoting sustainable behaviors, individuals can contribute to the overall goal of minimizing waste and preserving the environment for future generations.',
        }
        
        # Match the incoming message against regex patterns
        for pattern, response in patterns.items():
            if re.search(pattern, cm_message, re.IGNORECASE):
                cm_response = response
                break
        else:
            cm_response = "I'm sorry, I don't understand that message."
